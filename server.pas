...
type
  TdmServer = class(TDataModule)
    ...
    FDQРаботы: TFDQuery;
    intgrfldFDQЗаказыНомер: TIntegerField;
    wdstrngfldFDQЗаказыНазвание: TWideStringField;
    fdtncfldFDQЗаказыZID: TFDAutoIncField;
    intgrfldFDQЗаказыCID: TIntegerField;
    intgrfldFDQЗаказыMID: TIntegerField;
    intgrfldFDQЗаказыAID: TIntegerField;
    dtfldFDQЗаказыСоздан: TDateField;
    dtfldFDQЗаказыМакет: TDateField;
    dtfldFDQЗаказыГотовность: TDateField;
    blnfldFDQЗаказыБлокировка: TBooleanField;
    intgrfldFDQЗаказыСтоимость: TIntegerField;
    intgrfldFDQЗаказыАванс: TIntegerField;
    intgrfldFDQЗаказыДоплата: TIntegerField;
    dtmfldFDQЗаказыUpdate: TDateTimeField;
    wdmfldFDQЗаказыЗаметка: TWideMemoField;
    strngfldFDQЗаказыКлиент: TStringField;
    strngfldFDQЗаказыСтатус: TStringField;
    fdtncfldFDQСоставSID: TFDAutoIncField;
    intgrfldFDQСоставZID: TIntegerField;
    intgrfldFDQСоставWID: TIntegerField;
    intgrfldFDQСоставVID: TIntegerField;
    wdstrngfldFDQСоставОписание: TWideStringField;
    intgrfldFDQСоставКоличество: TIntegerField;
